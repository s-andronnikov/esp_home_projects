...
void HdVClock::render_() {
    ...
    lv_obj_set_style_pad_top(lv_main_, 2, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(lv_main_, 2, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_pad_column(value_container, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
...
//    lv_obj_set_style_text_font(lv_value_, &Material48, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(lv_value_, &RobotoMono48, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_pad_top(lv_value_, 1, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(lv_value_, 2, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_pad_bottom(text_container, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_column(text_container, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
...
//    lv_obj_set_style_text_font(text_lbl, &Font16, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(text_lbl, &RobotoReg14, LV_PART_MAIN | LV_STATE_DEFAULT);
