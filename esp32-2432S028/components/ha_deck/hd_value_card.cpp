...
void HdValueCard::render_() {
    ...
    lv_obj_set_height(value_container, !text_.empty() ? card_height * 0.6 : card_height * 0.95);
    ...
    if (text_.empty()) {
        ...
        lv_obj_set_style_pad_top(value_container, 0, (lv_style_selector_t)LV_PART_MAIN | (lv_style_selector_t)LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_pad_column(value_container, 5, (lv_style_selector_t)LV_PART_MAIN | (lv_style_selector_t)LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(lv_value_, &Font24, (lv_style_selector_t)LV_PART_MAIN | (lv_style_selector_t)LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_pad_top(lv_value_, 0, (lv_style_selector_t)LV_PART_MAIN | (lv_style_selector_t)LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(lv_value_, 0, (lv_style_selector_t)LV_PART_MAIN | (lv_style_selector_t)LV_STATE_DEFAULT);
    ...
    if (!unit_.empty())
    {
        ...
        lv_obj_set_style_text_color(unit_lbl, lv_color_hex(0xFFFFFF), (lv_style_selector_t)LV_PART_MAIN | (lv_style_selector_t)LV_STATE_DEFAULT);
        lv_obj_set_style_text_opa(unit_lbl, 255, (lv_style_selector_t)LV_PART_MAIN | (lv_style_selector_t)LV_STATE_DEFAULT);
        lv_obj_set_style_text_font(unit_lbl, &Font16, (lv_style_selector_t)LV_PART_MAIN | (lv_style_selector_t)LV_STATE_DEFAULT);
    }
    ...
    lv_obj_set_style_pad_bottom(text_container, 3, (lv_style_selector_t)LV_PART_MAIN | (lv_style_selector_t)LV_STATE_DEFAULT);
    lv_obj_set_style_pad_column(text_container, 4, (lv_style_selector_t)LV_PART_MAIN | (lv_style_selector_t)LV_STATE_DEFAULT);
    ...
    if (!icon_.empty()) {
        ...
        lv_obj_set_style_text_color(icon_lbl, lv_color_hex(0xFFFFFF), (lv_style_selector_t)LV_PART_MAIN | (lv_style_selector_t)LV_STATE_DEFAULT);
        lv_obj_set_style_text_opa(icon_lbl, 255, (lv_style_selector_t)LV_PART_MAIN | (lv_style_selector_t)LV_STATE_DEFAULT);
        lv_obj_set_style_text_font(icon_lbl, &Material24, (lv_style_selector_t)LV_PART_MAIN | (lv_style_selector_t)LV_STATE_DEFAULT);
    }
    if (!text_.empty())
    {
        ...
        lv_obj_set_style_text_font(text_lbl, &Font16, (lv_style_selector_t)LV_PART_MAIN | (lv_style_selector_t)LV_STATE_DEFAULT);
    }
